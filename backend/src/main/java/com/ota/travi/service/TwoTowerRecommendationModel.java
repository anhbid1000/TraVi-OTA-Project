...
public class TwoTowerRecommendationModel {
    ...
    public double[] buildItemEmbeddingForHotel(KhachSan hotel) {
        return buildItemEmbedding(ItemContext.fromHotel(hotel));
    }

    public double[] buildItemEmbeddingForRestaurant(NhaHang restaurant) {
        return buildItemEmbedding(ItemContext.fromRestaurant(restaurant));
    }

    public String summarizeHotelFeatures(KhachSan hotel) {
        return ItemContext.fromHotel(hotel).textCorpus();
    }

    public String summarizeRestaurantFeatures(NhaHang restaurant) {
        return ItemContext.fromRestaurant(restaurant).textCorpus();
    }
