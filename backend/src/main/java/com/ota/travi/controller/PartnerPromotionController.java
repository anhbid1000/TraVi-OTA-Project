...
public class PartnerPromotionController {
    ...
    public ResponseEntity<PromotionResponse> updatePromotion(
        ...
        logger.info("Updating promotion {} for partner: {}", id, getCurrentPartnerId(userDetails));
        String partnerId = getCurrentPartnerId(userDetails);
        PromotionResponse response = promotionService.updatePromotion(id, request, partnerId, false);
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
