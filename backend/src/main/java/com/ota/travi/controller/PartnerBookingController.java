...
public class PartnerBookingController {
    ...
    public PartnerBookingController(PartnerBookingService partnerBookingService) {
        this.partnerBookingService = partnerBookingService;
    }

    @GetMapping(PARTNER_BOOKINGS)
    ...
    @GetMapping(PARTNER_BOOKINGS + "/{bookingId}")
    ...
    @PatchMapping(PARTNER_BOOKINGS + "/{bookingId}/status")
