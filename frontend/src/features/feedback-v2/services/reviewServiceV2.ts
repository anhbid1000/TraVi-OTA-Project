...
export const reviewServiceV2 = {
  ...
  async createReview(payload: CreateReviewRequest): Promise<ReviewResponse> {
    try {
  ...
  // --- PARTNER ---
  async replyToReview(reviewId: string, payload: { noiDung: string }): Promise<ReviewResponse> {
    try {
